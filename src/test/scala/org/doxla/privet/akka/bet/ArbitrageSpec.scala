...
class ArbitrageSpec extends FlatSpec with MustMatchers {
  ...
  "A Back arbed with an equal oposite Lay" should "have a maximum exposure of zero" in {
    (Back(10, Odds(1), Matched) arbWith Lay(10, Odds(1), Matched)).maximumExposure must equal(0)
    (Back(1, Odds(10), Matched) arbWith Lay(1, Odds(10), Matched)).maximumExposure must equal(0)
    (Back(5, Odds(1.77), Matched) arbWith Lay(5, Odds(1.77), Matched)).maximumExposure must equal(0)
  }

  "A Lay arbed with an equal oposite Back" should "have a maximum exposure of zero" in {
    (Lay(10, Odds(1), Matched) arbWith Back(10, Odds(1), Matched)).maximumExposure must equal(0)
    (Lay(1, Odds(10), Matched) arbWith Back(1, Odds(10), Matched)).maximumExposure must equal(0)
    (Lay(5, Odds(1.77), Matched) arbWith Back(5, Odds(1.77), Matched)).maximumExposure must equal(0)
  }
